...
//黑马的接口不稳定，这里使用本地数据进行测试
const testData = ref({
  "userAddresses": [
    {
      "id": "1665013372078264322",
      "receiver": "老李2",
      "contact": "13900002020",
      "provinceCode": "210000",
      "cityCode": "210200",
...
const getCheckoutInfo = async () => {
  ...
  //用本地数据测试
  checkInfo.value = testData.value
      ...
      <div class="wrapper">
        ...
        <div class="box-body">
          <div class="address">
            ...
            <div class="action">
              <el-button size="large" @mouseenter="showDialog = true">切换地址</el-button>
